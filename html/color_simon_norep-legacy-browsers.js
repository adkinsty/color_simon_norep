...
function instructions_simonRoutineBegin(snapshot) {
  return function () {
    ...
    instructions_simonComponents.forEach( function(thisComponent) {
...
function trials_train_simonLoopBegin(trials_train_simonLoopScheduler) {
  ...
  trials_train_simon.forEach(function() {
...
function trials_train_timingLoopBegin(trials_train_timingLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trials_train_timing.forEach(function() {
...
function trial_train_simonRoutineBegin(snapshot) {
  return function () {
    ...
    trial_train_simonComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instructions_timingRoutineBegin(snapshot) {
  return function () {
    ...
    instructions_timingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_train_timingRoutineBegin(snapshot) {
  return function () {
    ...
    trial_train_timingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function feedback_timingRoutineBegin(snapshot) {
  return function () {
    ...
    feedback_timingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function feedback_testRoutineBegin(snapshot) {
  return function () {
    ...
    feedback_testComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function block_noteRoutineBegin(snapshot) {
  return function () {
    ...
    block_noteComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function completion_surveyRoutineBegin(snapshot) {
  return function () {
    ...
    completion_surveyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
